            ...
            {!linkSentTo ? (
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-3">
                ...
                <div className="relative my-3 flex items-center">
                  ...
                  <span className="mx-3 text-[10px] text-zinc-600">or</span>
                  <div className="flex-1 border-t border-white/10" />
                </div>
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] py-3 text-sm font-medium text-zinc-300 transition-all hover:border-white/20 hover:bg-white/[0.06] active:scale-[0.98] disabled:opacity-60"
                >
                  {isGoogleLoading ? (
                    <span className="h-4 w-4 animate-spin rounded-full border-2 border-zinc-400/20 border-t-zinc-400" />
                  ) : (
