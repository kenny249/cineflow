        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/[0.04]">
              {["User", "Plan", "Activity", "Joined", "Last seen", ""].map((h) => (
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="font-medium text-white leading-tight">
                        {u.name ?? <span className="text-zinc-500 font-normal">—</span>}
                        {u.is_admin && <Shield className="inline ml-1 h-3 w-3 text-[#d4a853]" />}
                      </p>
                ...
                <td className="px-4 py-3">
                  <div className="relative flex justify-end">
                    <button
                      ...
                      className="rounded-lg p-1.5 text-zinc-600 hover:bg-white/[0.05] hover:text-zinc-300 transition-colors"
                    >
                      <MoreHorizontal className="h-4 w-4" />
                    </button>

                    {openMenu === u.id && (
                      <div className="absolute right-0 top-8 z-50 min-w-[180px] rounded-xl border border-white/[0.08] bg-[#141414] p-1 shadow-xl">
                        ...
                        {PLANS.map((plan) => (
                          <button
                            ...
                            disabled={isPending}
                            className="flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-zinc-300 hover:bg-white/[0.05] transition-colors"
                          >
                        ...
                        <button
                          ...
                          className="flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-red-400 hover:bg-red-500/10 transition-colors disabled:opacity-40"
                        >
